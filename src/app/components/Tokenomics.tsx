            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl">
                ...
                <p className="text-gray-600">
                  Vote on select escrow disputes and platform feature proposals
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-100 p-6 rounded-xl">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900">Token Gating</h4>
                </div>
                <p className="text-gray-600">
                  Premium platform features for token holders
                </p>
              </div>
