          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6">
                "Kalygo has transformed how we manage our business. The platform is intuitive, powerful, and the customer support is exceptional."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6">
                "The analytics features have given us insights we never had before. Our productivity has increased by 40% since switching to Kalygo."
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-500 text-sm">Operations Manager, GrowthCo</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6">
                "Security was our biggest concern, but Kalygo's enterprise-grade security features put our minds at ease. Highly recommended!"
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-500 text-sm">CTO, SecureCorp</p>
                </div>
              </div>
            </div>
          </div>
